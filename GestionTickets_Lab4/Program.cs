...
// 2. CONFIGURACI�N DE IDENTITY (USUARIOS Y ROLES)
builder.Services.AddDefaultIdentity<IdentityUser>(options =>
{
    // A. Reglas de Password relajadas para el examen (M�s r�pido de escribir)
...
// ==============================================================================
// 4. ZONA DE "SEEDING" (CARGA AUTOM�TICA DE DATOS) - Adaptado de tu compa�ero
// ==============================================================================
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        var adminPass = "123"; // Contrase�a f�cil para testear
